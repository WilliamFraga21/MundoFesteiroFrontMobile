...
import 'evend_candidacy_model.dart';
export 'evend_candidacy_model.dart';

class EvendCandidacyWidget extends StatefulWidget {
  const EvendCandidacyWidget({super.key});

  @override
  State<EvendCandidacyWidget> createState() => _EvendCandidacyWidgetState();
}

class _EvendCandidacyWidgetState extends State<EvendCandidacyWidget> {
  late EvendCandidacyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EvendCandidacyModel());
  }
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.network(
                                      'https://cdn-icons-png.flaticon.com/512/1028/1028853.png',
                                      width: 70.0,
                                      height: 70.0,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.network(
                                      'https://cdn-icons-png.flaticon.com/512/6342/6342369.png',
                                      width: 70.0,
                                      height: 70.0,
                                      fit: BoxFit.cover,
                                    ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.network(
                                      'https://cdn-icons-png.flaticon.com/512/1038/1038726.png',
                                      width: 70.0,
                                      height: 70.0,
                                      fit: BoxFit.cover,
                                    ),
